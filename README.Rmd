...
- Results: data  
(Therefore, to get all the data you need to iterate over the pages by specifying
particular page of the results you want)
For example:
...
`get_person` function provides data on a person such as their donations to 
